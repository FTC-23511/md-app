...
| 3F — Captain/admin dashboard           | [2026-06-15-3f-captain-dashboard.md](2026-06-15-3f-captain-dashboard.md)         | ✅ **done** (#62) — roster + flag queue + KPI rollups                   |
| 3G — inbound Discord capture           | [2026-06-15-3g-discord-inbound.md](2026-06-15-3g-discord-inbound.md)             | ⏸ **deferred** — needs App-Lead Discord app + secrets; go/no-go pending |
