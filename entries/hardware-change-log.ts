...
export const hardwareChangeLogEntry: EntryDefinition = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Version',
      helper:
        'The new version number for this subsystem after the change. Decimals OK (e.g. 3.1). See the latest saved versions shown above the form.',
      required: true,
      storage: 'column',
      min: 0,
      decimals: true,
    ...
    },
    {
      ...
      helper: 'The previous version this change supersedes, if any. Decimals OK.',
      required: false,
      storage: 'column',
      min: 0,
      decimals: true,
